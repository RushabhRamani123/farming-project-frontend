...
export const MetricCard = ({ title, value, unit, icon: Icon, color }) => {
  ...
  const glowColor = color.replace('bg-', 'shadow-');
  ...
  return (
    <Card className="relative overflow-hidden group">
      ...
      <div className={`absolute -inset-0.5 bg-gradient-to-r ${gradient} rounded-lg blur opacity-30 group-hover:opacity-50 transition duration-500`} />
      ...
      <CardContent className="relative p-6 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm rounded-lg space-y-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className={`relative p-3 rounded-xl bg-gradient-to-br ${gradient} shadow-lg group-hover:scale-110 transform transition-transform duration-300`}>
            ...
            <div className="flex flex-col">
              ...
              <div className={`h-0.5 w-0 bg-gradient-to-r ${gradient} group-hover:w-full transition-all duration-300`} />
            </div>
          </div>
          ...
          <div className="flex items-baseline space-x-1">
            ...
            <div className={`text-lg font-medium bg-gradient-to-br ${gradient} bg-clip-text text-transparent`}>
              {unit}
            </div>
          </div>
        </div>
